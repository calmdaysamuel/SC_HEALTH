 ...
 * Use the [RecordFoodFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RecordFoodFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        calorieField = view.findViewById(R.id.calorieField)
        recordFoodButton = view.findViewById(R.id.recordFood)
...
//            )
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_record_food, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RecordFoodFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RecordFoodFragment().apply {
